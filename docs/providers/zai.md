...
UsagePal is a GUI app. A one-off `export ...` in a terminal session will not be visible when you launch UsagePal from
Spotlight/Launchpad. Persist it, then restart UsagePal.
...
3. Enable the Z.ai plugin in UsagePal settings
