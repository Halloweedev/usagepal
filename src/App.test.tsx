...
describe("App", () => {
  ...
  it("covers about open/close callbacks", async () => {
    ...
    await userEvent.click(await screen.findByRole("button", { name: /UsagePal/i }))
    await screen.findByText("Built by Nicolas Demanez")

    // Close about via ESC key
    document.dispatchEvent(new KeyboardEvent("keydown", { key: "Escape" }))
    await waitFor(() => {
      expect(screen.queryByText("Built by Nicolas Demanez")).not.toBeInTheDocument()
    })
  })
